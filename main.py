...
class RapScraperMainApp:
        ...
        while True:
            ...
            try:
                ...
                if choice == "":
                    ...
                    print("🚀 Quick start: Beginning scraping from remaining_artists.json...")
    ...
    async def scrape_artist_list(self) -> None:
        ...
        try:
            ...
            for i, artist in enumerate(artists, 1):
                ...
                result = await self._run_artist_scraping(scraper, artist, songs_per_artist)
    ...
    def scrape_from_remaining_artists(self) -> None:
        ...
        try:
            ...
            with open("data/remaining_artists.json", 'r', encoding='utf-8') as f:
                data = json.load(f)
            ...
            for i, artist in enumerate(artists, 1):
                ...
                try:
                    ...
                    if not self.scraper:
                        print(f"  ❌ Scraper not available (no Genius token)")
                        continue
                        
                    songs_scraped = self.scraper.scrape_artist_songs(artist, max_songs=songs_per_artist)
    ...
    async def _run_artist_scraping(self, scraper, artist_name: str, max_songs: int) -> Dict[str, Any]:
