...
class TestQuickBenchmarks:
    ...
    def test_analyzer_comparison_advanced_algorithmic(self, benchmark, rap_app, quick_test_texts):
        ...
        def batch_analysis():
            ...
            for i, text in enumerate(quick_test_texts):  # Только 3 текста
                if hasattr(analyzer, 'analyze_song'):
                    ...
                    result = analyzer.analyze(text) if hasattr(analyzer, 'analyze') else None
