...
def save_remaining_artists(artists: list, processed_count: int):
    ...
    if remaining:
        ...
        logging.info(f"💾 Сохранено {len(remaining)} оставшихся артистов в {remaining_file}")
...
def main():
    ...
    try:
        ...
        logger.info(f"📚 Текущая БД: {initial_stats['total_songs']} песен от {initial_stats['unique_artists']} артистов")
