...
from models.models import SpotifyArtist, SpotifyTrack, SpotifyAudioFeatures
...
def temp_db():
    ...
    # Тестовые данные
    test_songs = [
        (1, "Hotline Bling", "Drake", "You used to call me on my...", "https://genius.com/1"),
        (2, "HUMBLE.", "Kendrick Lamar", "Sit down, be humble...", "https://genius.com/2"),
